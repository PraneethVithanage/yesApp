...
struct LiveProgram: Codable {
    ...
    let imageURLMedium, imageURLLarge: String
    let rating: Int
    let ratingStatus, followingStatus: Bool
    let noOfFollowers: Int
    let noOfFollowersF, startTime, endTime, period: String
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case imageURLSmall = "ImageUrlSmall"
        case imageURLMedium = "ImageUrlMedium"
        case imageURLLarge = "ImageUrlLarge"
        case rating, ratingStatus, followingStatus
        case noOfFollowers = "NoOfFollowers"
        case noOfFollowersF = "NoOfFollowersF"
